...
import static org.openstack.burrow.backend.http.BaseHttp.handleMultipleMessageHttpResponse;
...
public class FutureMessageList implements Future<List<Message>> {
  ...
  @Override
  public synchronized List<Message> get(long timeout, TimeUnit unit) throws InterruptedException,
