...
/**
 * QueueResponse extends Queue and provides the ability to handle response from
 * the server asynchronously
 */
class QueueResponse extends Queue {

  /**
   * Constructor for QueueResponse that takes an Account and a JSONObject as
   * arguments
   * 
   * @param account The Account in which the Queue resides
   * @param queue A JSONObject that contains the Queue name
   * @throws JSONException Arises if an error occurs while getting the Queue
   *           name
   */
  ...
  /**
   * Constructor for QueueResponse that takes an Account and a String as
   * arguments
   * 
   * @param account The Account in which the Queue resides
  ...
  /**
   * Constructor for QueueResponse that takes a QueueListRequest and a
   * JSONObject as arguments
   * 
   * @param request A QueueListRequest object that contains the Account for the
   *          Queue
   * @param queue A JSONObject that contains the Queue name
   * @throws JSONException Arises if an error occurs while getting the Queue
   *           name
