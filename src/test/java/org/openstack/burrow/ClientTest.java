...
public abstract class ClientTest extends TestCase {
    ...
    public void testNullHandling() throws CommandException, ProtocolException {
        try {
            backend.execute((CreateMessage) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((DeleteAccounts) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((DeleteMessage) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((DeleteMessages) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((DeleteQueues) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((GetAccounts) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((GetMessage) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((GetMessages) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((GetQueues) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((UpdateMessage) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }
        try {
            backend.execute((UpdateMessages) null);
        } catch (IllegalArgumentException e) {
            //Expected
        }

        backend.execute(queue.createMessage("foo", "foo"));
